...
export default function EventMap({
  ...
  return (
    <div className="relative group">
      ...
      <div className="relative bg-white/5 backdrop-blur-sm rounded-[24px] overflow-hidden shadow-2xl border border-white/10">
        {/* Map */}
        ...
        <div className="p-6 sm:p-8 bg-secondary/50">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="font-bold text-lg text-white">{venue}</h3>
            ...
            <a
              ...
              className="flex-shrink-0 flex items-center gap-2 px-4 py-2.5 bg-primary hover:bg-primary-dark text-white text-sm font-medium rounded-xl transition-colors duration-200"
            >
