    ...
    <>
      ...
      <div className="min-h-screen bg-secondary noise-overlay relative flex items-center justify-center pt-16">
        ...
        <div className="relative z-10 max-w-md w-full mx-4">
          <div className="bg-white/5 backdrop-blur-sm rounded-[24px] shadow-xl p-8 text-center border border-white/10">
            {status === "pending" && (
              <>
                ...
                <p className="text-gray-400 text-sm mb-4">
                  ...
                  {tx && <span className="block text-gray-500 text-xs mt-2">Réf: {tx}</span>}
                </p>
            ...
            {status === "completed" && (
              <>
                ...
                <p className="text-gray-400 text-sm mb-1">
                  ...
                  {method && <span className="block text-gray-500 text-xs mt-1">Payé via {method}</span>}
                </p>
                <div className="space-y-3 mt-5">
                  ...
                  <Link href={`/events/${slug}`} className="block w-full bg-white/5 hover:bg-white/10 text-gray-300 py-3 rounded-[10px] text-sm font-medium transition-colors border border-white/10">
            ...
            {status === "failed" && (
              <>
                ...
                <p className="text-gray-400 text-sm mb-4">Le paiement n&apos;a pas pu être traité. Veuillez réessayer.</p>
